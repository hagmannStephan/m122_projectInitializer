...
### Use Cases
- Ich als Nutzer kann, wenn ich das Skript ausführe, als erstes Argument, den Projekttyp angeben.
- Ich als Nutzer kann, wenn ich das Skript ausführe, als zweites Argument, den Pfad angeben, bei dem das Projekt erstellt werden soll.
